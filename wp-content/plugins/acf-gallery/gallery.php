...
class acf_field_gallery extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->l10n = array(
			'select'		=>	__("Добавить в галерею",'acf'),
			'edit'			=>	__("Редактировать",'acf'),
			'update'		=>	__("Обновить изображение",'acf'),
			'uploadedTo'	=>	__("добавлено к текущей записи",'acf'),
			'count_0'		=>	__("Изображений не выюрано",'acf'),
			'count_1'		=>	__("1 изображение выбрано",'acf'),
			'count_2'		=>	__("изображений выбрано - %d",'acf'),
		);
